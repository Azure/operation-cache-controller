...
IMG ?= operation-cache-controller:v0.0.1
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name operation-cache-controller-builder
	$(CONTAINER_TOOL) buildx use operation-cache-controller-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm operation-cache-controller-builder
	rm Dockerfile.cross
