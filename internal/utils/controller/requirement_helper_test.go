...
var reqHelper = NewRequirementHelper()
...
func TestIsCacheMissed(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			conditions: []metav1.Condition{
				{
					Type:   v1alpha1.RequirementConditionCachedOperationAcquired,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got := reqHelper.IsCacheMissed(req)
...
func TestUpdateCondition(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			changed := reqHelper.UpdateCondition(req, tt.conditionType, tt.conditionStatus, tt.reason, tt.message)
