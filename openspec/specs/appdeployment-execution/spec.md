# appdeployment-execution Specification

## Purpose
Specify AppDeployment reconciliation for dependency-gated provision jobs, teardown jobs, deletion finalizers, and Job ownership.
## Requirements
